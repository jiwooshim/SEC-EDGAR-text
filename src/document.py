...
from .utils import storage_toplevel_directory, all_subdir, all_files
...
class Document(object):
    ...
    def get_excerpt(self, input_text, form_type, metadata_master,
        ...
        for section_search_terms in master_search_terms[form_type]:
            ...
            if os.path.split(txt_output_path)[-1] in all_files:
                logger.info("File already exists, skipping: " + os.path.split(txt_output_path)[-1])
                continue
